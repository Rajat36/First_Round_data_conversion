...
select * from LND_INDI_ACC_WITH_JURIS 
 ...
 select count(*),substring(errorMessage,1,70) from STG_CONTACT_INDI_ATTY_WITH_JURIST_ID_CONV_FAIL group by substring(errorMessage,1,70)



 M_ATTY not like '%LLC%' and NM_ATTY not like '%FIRM%' and
NM_ATTY not like '%SERVICE%' and NM_ATTY not like '%LAW%' and
NM_ATTY not like '%OFFICES%' and
NM_ATTY not like '%&%' and
NM_ATTY not like '%ASSOCIATES%' and
